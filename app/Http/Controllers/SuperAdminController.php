...
class SuperAdminController extends Controller
{
    ...
    public function showUsers(Request $request, $aksi, $id)
    {
        if ($aksi == 'data') {
            ...
            $pegawai   = Pegawai::get();
            $pengguna  = User::join('tbl_pegawai', 'tbl_pegawai.id_pegawai', 'users.pegawai_id')
    ...
    public function showEmployees(Request $request, $aksi, $id)
    {
        if ($aksi == 'data') {
            ...
            $unitKerja = UnitKerja::get();
            $pegawai   = Pegawai::join('tbl_pegawai_jabatan', 'tbl_pegawai_jabatan.id_jabatan', 'tbl_pegawai.jabatan_id')
            ->join('tbl_unit_kerja', 'tbl_unit_kerja.id_unit_kerja', 'tbl_pegawai.unit_kerja_id')
            ...
            $pegawai = new Pegawai();
            $pegawai->id_pegawai         = random_int(1000, 9999);
