        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ url('admin-user/aadb/kendaraan/daftar/seluruh-kendaraan') }}">Master Kendaraan</a></li>
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-4 order-2 order-md-1">
                    ...
                    <p class="text-muted text-capitalize">
                        {{ $kendaraan->jenis_kendaraan.' '.$kendaraan->merk_tipe_kendaraan.' '. \Carbon\Carbon::parse($kendaraan->tahun_kendaraan)->isoFormat('Y') }}
                    </p>
                    <br>
