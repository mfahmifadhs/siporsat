                            ...
                            <div class="row">
                                <div class="col-md-7 col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">:
                                            <a href="{{ url('admin-user/cetak-surat/usulan-ukt/'. $usulan->id_form_usulan) }}" rel="noopener" target="_blank" class="btn btn-danger btn-sm pdf">
                                                <i class="fas fa-print"></i> Cetak
                                            </a>
                                            <a href="{{ route('ukt.edit', $id) }}" class="btn btn-warning btn-sm pdf">
