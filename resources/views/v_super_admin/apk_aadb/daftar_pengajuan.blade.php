                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        Jatuh Tempo Servis : {{ $dataServis->jatuh_tempo_servis }} KM<br>
                                        Jatuh Tempo Ganti Oli : {{ $dataServis->jatuh_tempo_ganti_oli }} KM<br>
                                        Tanggal Terakhir Servis : {{ $dataServis->tgl_servis_terakhir }} <br>
                                        Tanggal Terakhir Ganti Oli : {{ $dataServis->tgl_ganti_oli_terakhir }}
                                        @endforeach
                                        @endif
                                        ...
                                        Masa Berlaku STNK lama : {{ $dataStnk->mb_stnk_lama }} <br>
                                        Masa Berlaku STNK Baru : {{ $dataStnk->mb_stnk_baru }} <br>
                                        Biaya Perpanjangan : Rp {{ number_format($dataStnk->biaya_perpanjangan, 0, ',', '.') }}
                                        @endforeach
                                        @endif
                                        ...
                                        Voucher 25 : {{ $dataVoucher->voucher_25 }} <br>
                                        Voucher 50 : {{ $dataVoucher->voucher_50 }} <br>
                                        Voucher 100 : {{ $dataVoucher->voucher_100 }} <br>
                                        Total Biaya : Rp {{ number_format($dataVoucher->total_biaya, 0, ',', '.') }}
                                        @endforeach
                                        @endif
                                    </td>
                                    <td class="text-center">
                                        ...
                                        <a href="{{ asset('gambar/kwitansi/pengadaan/'. $dataUsulan->lampiran) }}" class="btn btn-primary btn-xs" download>
                                            <i class="fas fa-download"></i> Unduh
                                        </a>
                                        @endif
                                        @if ($dataUsulan->jenis_form == 2)
                                        <span>Bukti Kwitansi : </span> <br>
                                        <a href="{{ asset('gambar/kwitansi/servis/'. $dataUsulan->lampiran) }}" class="btn btn-primary btn-xs" download>
                                            <i class="fas fa-download"></i> Unduh
                                        </a>
                                        @endif
                                        @if ($dataUsulan->jenis_form == 3)
                                        <span>Bukti Kwitansi : </span> <br>
                                        <a href="{{ asset('gambar/kendaraan/stnk/'. $dataUsulan->lampiran) }}" class="btn btn-primary btn-xs" download>
                                            <i class="fas fa-download"></i> Unduh
                                        </a>
                                        @endif
                                        @endif
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item btn" href="{{ url('super-admin/aadb/usulan/hapus/'. $dataUsulan->id_form_usulan) }}" onclick="return confirm('Apakah anda ingin menghapus usulan ini ?')">
