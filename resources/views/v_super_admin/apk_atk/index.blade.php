                        ...
                        <div class="card-header">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 mt-2 text-right">
                                    ...
                                    <a href="{{ url('super-admin/atk/dashboard') }}" class="btn btn-danger">
...
<script>
    ...
    $(function() {
        ...
        for (let i = 1; i <= 4; i++) {
            $(".select2-" + i).select2({
                ajax: {
                    url: `{{ url('super-admin/atk/select2-dashboard/` + i + `/barang') }}`,
                    type: "post",
                    dataType: 'json',
                    delay: 250,
    ...
    $('body').on('click', '#searchChartData', function() {
        ...
        if (kategori || jenis || nama || merk) {
            url = '<?= url("/super-admin/atk/grafik?kategori='+kategori+'&jenis='+jenis+'&nama='+nama+'&merk='+merk+'") ?>'
        } else {
            url = '<?= url("/super-admin/atk/grafik") ?>'
        }
