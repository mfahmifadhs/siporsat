        ...
        <div class="row text-capitalize">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ url('super-admin/'.$modul.'/dashboard') }}">Dashboard</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 form-group">
                <a href="{{ url('super-admin/'.$modul.'/dashboard') }}" class="btn btn-primary print mr-2">
                    <i class="fas fa-home"></i>
                </a>
                <a href="{{ url('super-admin/cetak-surat/usulan-'. $modul.'/'. $usulan->id_form_usulan) }}" rel="noopener" target="_blank" class="btn btn-danger pdf">
