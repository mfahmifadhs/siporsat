            ...
            <div class="col-md-12">
                <div class="card card-outline card-primary" id="accordion">
                    ...
                    <div id="collapseTwo" class="collapse" data-parent="#accordion">
                        <div class="card-header">
                            <form method="POST" action="{{ url('super-user/aadb/usulan/daftar/seluruh-usulan') }}">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <small>Pilih Jenis Usulan AADB</small>
                                    ...
                                    <div class="col-sm-2 text-right">
                                        ...
                                        <a href="{{ url('super-user/aadb/usulan/daftar/seluruh-usulan') }}" class="btn btn-danger">
