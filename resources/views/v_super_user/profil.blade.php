        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card text-center">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ url('super-user/profil/reset-autentikasi/'. $user->id) }}" class="btn btn-danger" onclick="return confirm('Apakah anda ingin mereset ulang 2fa autentikasi ?')">
            ...
            <div id="modal">
                ...
                <div class="modal fade" id="editProfile" tabindex="-1" role="dialog" aria-labelledby="editProfile" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <form action="{{ url('super-user/profil/edit-profil/'. Auth::user()->id) }}" method="POST">
                                @csrf
                ...
                <div class="modal fade" id="editPassword" tabindex="-1" role="dialog" aria-labelledby="editPassword" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <form action="{{ url('super-user/profil/edit-password/'. Auth::user()->id) }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_pegawai" value="{{ $user->id_pegawai }}">
                                <div class="modal-header">
