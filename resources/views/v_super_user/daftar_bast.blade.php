                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ url('super-user/surat/detail-bast-atk/'. $detailAtk->id_bast) }}" class="dropdown-item btn" type="button">
...
<div class="modal fade" id="modal-add-atk">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ url('super-user/atk/gudang/insert/atk') }}" method="POST">
                @csrf
...
<div class="modal fade" id="modal-add-kategori">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ url('super-user/atk/gudang/insert/kategori') }}" method="POST">
                @csrf
                <div class="modal-body text-capitalize">
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Kode Kategori</label>
