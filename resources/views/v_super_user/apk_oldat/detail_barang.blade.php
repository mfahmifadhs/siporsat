                            ...
                            <div class="active tab-pane" id="informasi-barang">
                                <form action="{{ url('admin-user/oldat/barang/proses-ubah/'. $barang->id_barang) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>NUP : </label>
                                            <input type="text" name="nup_barang" class="form-control" value="{{ $barang->nup_barang }}" readonly>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label>Jumlah : </label>
                                            <input type="text" name="jumlah_barang" class="form-control" value="{{ $barang->jumlah_barang }}" readonly>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label>Satuan : </label>
                                            <input type="text" name="satuan_barang" class="form-control" value="{{ $barang->satuan_barang }}" readonly>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label>Tahun Perolehan : </label>
                                            <input type="text" name="tahun_perolehan" class="form-control" value="{{ $barang->tahun_perolehan }}" readonly>
                                        </div>
                                        <div class="col-md-6 form-group">
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea type="text" name="spesifikasi_barang" class="form-control" rows="5" readonly>{{ $barang->spesifikasi_barang}}</textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
