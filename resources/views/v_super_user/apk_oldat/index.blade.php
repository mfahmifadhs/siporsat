...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="m-0">Dashboard Olah Data BMN & Meubelair</h4>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-12">
                <div class="card card-primary card-outline" id="accordion">
                    <div class="card-header">
                        <h4 class="card-title font-weight-bold" style="font-size: 14px;">
                            <i class="fas fa-table"></i> TOTAL USULAN
                        </h4>
                    </div>
                    <div class="card-body">
                        <table id="table-rekap" class="table table-bordered text-center">
                            <thead>
                                <tr class="bg-light">
                                    <th>No</th>
                                    <th>Bulan</th>
                ...
                <div class="card card-primary card-outline" id="accordion">
                    <div class="card-header">
                        <b class="font-weight-bold">
                            <i class="fas fa-table"></i> TABEL DAFTAR BARANG
                        </b>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center pt-4">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item btn" href="{{ url('super-user/verif/usulan-oldat/'. $dataUsulan->id_form_usulan) }}">
                                                <i class="fas fa-file-signature"></i> Verifikasi
                                            </a>
                                            <a class="dropdown-item btn" href="{{ url('super-user/oldat/pengajuan/proses-pembatalan/'. $dataUsulan->id_form_usulan) }}" onclick="return confirm('Apakah anda ingin membatalkan usulan ini ?')">
                                            ...
                                            <div class="modal-body text-capitalize">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">:
                                                            {{ $dataPengadaan->kategori_barang }}
                                                        </div>
                                                        <div class="col-md-4"><label>Merk </label></div>
                                                        <div class="col-md-8">:
                                                            {{ $dataPengadaan->merk_barang }}
                                                        </div>
