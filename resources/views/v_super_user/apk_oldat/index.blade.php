                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group small text-right">
                                            {{ $usulan->where('jenis_form', 'pengadaan')->where('status_proses_id', 1)->count() }}
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-4 form-group small text-right">
                                            {{ $usulan->where('jenis_form', 'pengadaan')->where('status_proses_id', 2)->count() }}
                                        </div>
                                        <div class="col-md-12">
                                            <hr style="border: 1px solid grey;margin-top:-1vh;">
                                        </div>
                                        ...
                                        <div class="col-md-4 form-group small text-right">
                                            {{ $usulan->where('jenis_form', 'pengadaan')->where('status_proses_id', 4)->count() }}
                                        </div>
                                        <div class="col-md-12">
                                            <hr style="border: 1px solid grey;margin-top:-1vh;">
                                        </div>
                                        ...
                                        <div class="col-md-4 form-group small text-right">
                                            {{ $usulan->where('jenis_form', 'pengadaan')->where('status_proses_id', 5)->count() }}
                                        </div>
                                        <div class="col-md-12">
                                            <hr style="border: 1px solid grey;margin-top:-1vh;">
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8 form-group small">Menunggu Persetujuan</div>
                                        <div class="col-md-4 form-group small text-right">
                                            {{ $usulan->where('jenis_form', 'perbaikan')->where('status_proses_id', 1)->count() }}
                                        </div>
                                        <div class="col-md-12">
                                            <hr style="border: 1px solid grey;margin-top:-1vh;">
                                        </div>
                                        <div class="col-md-8 form-group small">Sedang Diproses</div>
                                        <div class="col-md-4 form-group small text-right">
                                            {{ $usulan->where('jenis_form', 'perbaikan')->where('status_proses_id', 2)->count() }}
                                        </div>
                                        <div class="col-md-12">
                                            <hr style="border: 1px solid grey;margin-top:-1vh;">
                                        </div>
                                        <div class="col-md-8 form-group small">Menunggu Konfirmasi</div>
                                        <div class="col-md-4 form-group small text-right">
                                            {{ $usulan->where('jenis_form', 'perbaikan')->where('status_proses_id', 4)->count() }}
                                        </div>
                                        <div class="col-md-12">
                                            <hr style="border: 1px solid grey;margin-top:-1vh;">
                                        </div>
                                        <div class="col-md-8 form-group small">Selesai</div>
                                        <div class="col-md-4 form-group small text-right">
                                            {{ $usulan->where('jenis_form', 'perbaikan')->where('status_proses_id', 5)->count() }}
                                        </div>
                                        <div class="col-md-12">
                                            <hr style="border: 1px solid grey;margin-top:-1vh;">
                                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pt-2 small">
                                                ...
                                                @if ($dataUsulan->status_proses_id == 1)
                                                    <span class="badge badge-sm badge-pill badge-warning">menunggu <br>
                                                        persetujuan</span>
                                                @elseif ($dataUsulan->status_proses_id == 2)
                                                    <span class="badge badge-sm badge-pill badge-warning">sedang <br>
                                                        diproses ppk</span>
                                                @elseif ($dataUsulan->status_proses_id == 3)
                                                    <span class="badge badge-sm badge-pill badge-warning">menunggu <br>
                                                        konfirmasi pengusul</span>
                                                @elseif ($dataUsulan->status_proses_id == 4)
                                                    <span class="badge badge-sm badge-pill badge-warning">menunggu <br>
                                                        konfirmasi kabag rt</span>
                                                ...
                                                <div class="dropdown-menu">
                                                    @if (Auth::user()->pegawai->jabatan_id == 2 && $dataUsulan->status_proses_id == 1)
                                                        <a class="dropdown-item btn"
                                                            href="{{ url('super-user/oldat/pengajuan/persetujuan/' . $dataUsulan->id_form_usulan) }}">
                                                            <i class="fas fa-arrow-alt-circle-right"></i> Proses
                                                        </a>
                                                    @elseif (Auth::user()->pegawai->jabatan_id == 5 && $dataUsulan->status_proses_id == 2)
                                                        <a class="dropdown-item btn"
                                                            href="{{ url('super-user/ppk/oldat/pengajuan/' . $dataUsulan->jenis_form . '/' . $dataUsulan->id_form_usulan) }}">
                                                            <i class="fas fa-arrow-alt-circle-right"></i> Proses Penyerahan
                                                        </a>
                                                    @elseif ($dataUsulan->status_proses_id == 4)
                                                        <a class="dropdown-item btn"
                                                            href="{{ url('super-user/oldat/surat/surat-bast/' . $dataUsulan->id_form_usulan) }}">
                                                            <i class="fas fa-arrow-alt-circle-right"></i> BAST
                                                        </a>
                                                    @endif
                                                    <a class="dropdown-item btn" type="button" data-toggle="modal"
                                                        data-target="#modal-info-{{ $dataUsulan->id_form_usulan }}">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        @elseif ($dataUsulan->status_pengajuan_id == 1)
                                                            ...
                                                            @elseif($dataUsulan->status_proses_id == 3)
                                                                <span class="border border-warning">
                                                                    <b class="text-warning p-3">menunggu konfirmasi
                                                                        pengusul</b>
                                                                </span>
                                                            @elseif($dataUsulan->status_proses_id == 4)
                                                                <span class="border border-warning">
                                                                    <b class="text-warning p-3">menunggu konfirmasi kabag
                                                                        rt</b>
                                                                </span>
                                                            @elseif($dataUsulan->status_proses_id == 5)
                                                                <span class="border border-warning">
                                                    ...
                                                    <div class="modal-body text-capitalize">
                                                        ...
                                                        <div class="form-group row mb-0">
                                                            ...
                                                            <div class="col-md-8">:
                                                                {{ $dataUsulan->jabatan . ' ' . $dataUsulan->keterangan_pegawai }}
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-0">
                                                        ...
                                                        @if ($dataUsulan->jenis_form == 'pengadaan')
                                                            <div class="form-group row mb-0">
                                                                <div class="col-md-4"><label>Rencana Pengguna </label>
                                                                </div>
                                                                <div class="col-md-8">:
                                                                    {{ $dataUsulan->rencana_pengguna }}</div>
                                                            </div>
                                                        @else
                                                            <div class="form-group row mb-0">
                                                                <div class="col-md-4"><label>Biaya Perbaikan :</label>
                                                                </div>
                                                                <div class="col-md-8">: Rp
                                                                    {{ number_format($dataUsulan->total_biaya, 0, ',', '.') }}
                                                                </div>
                                                            </div>
                                                        @endif
                                                            ...
                                                            @foreach ($dataUsulan->detailPengadaan as $dataPengadaan)
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-8">:
                                                                            {{ $dataPengadaan->kategori_barang }}</div>
                                                                        <div class="col-md-4"><label>Merk </label></div>
                                                                        <div class="col-md-8">:
                                                                            {{ $dataPengadaan->merk_barang }}</div>
                                                                        <div class="col-md-4"><label>Jumlah </label></div>
                                                                        <div class="col-md-8">:
                                                                            {{ $dataPengadaan->jumlah_barang . ' ' . $dataPengadaan->satuan_barang }}
                                                                        </div>
                                                                        <div class="col-md-4"><label>Estimasi Biaya</label>
                                                                        </div>
                                                                        <div class="col-md-8">: Rp
                                                                            {{ number_format($dataPengadaan->estimasi_biaya, 0, ',', '.') }}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            @endforeach
                                                            ...
                                                            @foreach ($dataUsulan->detailPerbaikan as $dataPerbaikan)
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-8">:
                                                                            {{ $dataPerbaikan->kategori_barang }}</div>
                                                                        <div class="col-md-4"><label>Merk Barang </label>
                                                                        </div>
                                                                        <div class="col-md-8">:
                                                                            {{ $dataPerbaikan->merk_tipe_barang }}</div>
                                                                        <div class="col-md-4"><label>Pengguna </label>
                                                                        </div>
                                                                        <div class="col-md-8">:
                                                                            {{ $dataPerbaikan->nama_pegawai }}</div>
                                                                        <div class="col-md-4"><label>Unit Kerja</label>
                                                                        </div>
                                                                        <div class="col-md-8">:
                                                                            {{ $dataPerbaikan->unit_kerja }}</div>
                                                                        <div class="col-md-4"><label>Tahun
                                                                                Perolehan</label></div>
                                                                        <div class="col-md-8">:
                                                                            {{ $dataPerbaikan->tahun_perolehan }}</div>
                                                                    </div>
                                                                </div>
                                                            @endforeach
                                                        @endif
                                                        ...
                                                        <div class="col-md-12">
                                                            <span style="float: left;">
                                                                @if ($dataUsulan->status_proses_id == 5)
                                                                    <a href="{{ url('super-user/oldat/surat/surat-bast/' . $dataUsulan->id_form_usulan) }}"
                                                            ...
                                                            <span style="float: right;">
                                                                <a href="{{ url('super-user/oldat/surat/surat-usulan/' . $dataUsulan->id_form_usulan) }}"
                                                                    class="btn btn-primary">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    ...
                                    <select name="barang" id="barang`+ i +`"
                                        class="form-control text-capitalize select2-1">
                                        <option value="">-- NAMA BARANG --</option>
                                    </select>
                                </div>
                                <div class="col-sm-4">
                                    <label>Unit Kerja</label> <br>
                                    <select name="unitkerja" id="unitkerja`+ i +`"
                                        class="form-control text-capitalize select2-2">
                                        <option value="">-- UNIT KERJA --</option>
                                    </select>
                                </div>
                                <div class="col-sm-4">
                                    <label>Kondisi</label> <br>
                                    <select name="kondisi" id="kondisi`+ i +`"
                                        class="form-control text-capitalize select2-3">
