                ...
                <div class="row">
                    <div class="col-md-12 form-group">
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-10 text-uppercase">: {{ ucfirst(strtolower($usulan->no_surat_usulan)) }}</div>
                        </div>
                        <div class="form-group row mb-0">
                    ...
                    <div class="col-md-12 mt-4">
                        <div class="row text-center">
                            <label class="col-sm-6">{!! QrCode::size(100)->generate('https://siporsat.app/surat/usulan-oldat/'.$usulan->otp_usulan_pengusul) !!}</label>
                            @if ($usulan->otp_usulan_kabag != null)
                            <label class="col-sm-6">{!! QrCode::size(100)->generate('https://siporsat.app/surat/usulan-oldat/'.$usulan->otp_usulan_kabag) !!}</label>
                            @endif
                        </div>
                    </div>
                    <div class="col-md-12 mt-4">
