...
<section class="content">
    <div class="container">
        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <form action="{{ url('super-user/ukt/usulan/edit/'. $usulan->id_form_usulan) }}" method="POST">
                    @csrf
                    ...
                    <div id="main-ukt">
                        @foreach ($usulan->detailUsulanUkt as $detail)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control text-uppercase" name="lokasi_pekerjaan[]" value="{{ $detail->lokasi_pekerjaan }}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10 text-right">
                                <button type="submit" class="btn btn-primary font-weight-bold" onclick="return confirm('Apakah anda ingin mengubah usulan ?')">
