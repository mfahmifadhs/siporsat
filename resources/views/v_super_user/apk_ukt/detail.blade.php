    ...
    <div class="container">
        <div class="row text-capitalize">
            ...
            <div class="col-sm-6 text-right my-auto">
                ...
                <a href="{{ url($url.'/cetak-surat/usulan-ukt/'. $usulan->id_form_usulan) }}" rel="noopener" target="_blank" class="btn btn-default border-dark btn-sm pdf">
                    <i class="fas fa-file-alt"></i> Surat Usulan
                </a>
                <a href="{{ url($url.'/cetak-surat/bast-ukt/'. $usulan->id_form_usulan) }}" class="btn btn-default border-dark btn-sm pdf" target="_blank">
