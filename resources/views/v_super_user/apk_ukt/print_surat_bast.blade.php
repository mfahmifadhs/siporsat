            ...
            <div class="col-md-12 mt-5 text-capitalize">
                <div class="col-md-12">
                    <div class="row text-center">
                        <label class="col-sm-6">Yang Mengusulkan, <br> {{ ucfirst(strtolower($bast->keterangan_pegawai)) }}</label>
                        @if ($bast->otp_usulan_kabag != null)
                ...
                <div class="col-md-12 mt-4">
                    <div class="row text-center">
                        <label class="col-sm-6">{!! QrCode::size(100)->generate('https://siporsat.kemkes.go.id/surat/usulan-ukt/'.$bast->otp_usulan_pengusul) !!}</label>
                        @if ($bast->otp_usulan_kabag != null)
                        <label class="col-sm-6">{!! QrCode::size(100)->generate('https://siporsat.kemkes.go.id/surat/usulan-ukt/'.$bast->otp_usulan_kabag) !!}</label>
                        @endif
                    </div>
                </div>
                <div class="col-md-12 mt-4">
                    <div class="row text-center">
                        <label class="col-sm-6">{{ ucfirst(strtolower($bast->nama_pegawai)) }}</label>
                        @if ($bast->otp_usulan_kabag != null )
