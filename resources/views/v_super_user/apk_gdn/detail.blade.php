...
<section class="content-header">
    <div class="container">
        <div class="row text-capitalize">
            <div class="col-sm-6">
                <h1 class="m-0 text-lg">Detail Usulan</h1>
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('gdn.show', ['aksi' => 'pengajuan', 'id' => '*']) }}">Daftar</a></li>
                    <li class="breadcrumb-item active">Detail</li>
                </ol>
            </div>
            <div class="col-sm-6 text-right my-auto">
                <a href="{{ route('gdn.edit', $id) }}" class="btn btn-default border-dark btn-sm pdf">
                    <i class="fas fa-edit"></i> Edit
                </a>
                <a href="{{ url($url.'/cetak-surat/usulan-gdn/'. $usulan->id_form_usulan) }}" rel="noopener" target="_blank" class="btn btn-default border-dark btn-sm pdf">
                    <i class="fas fa-file-alt"></i> Surat Usulan
                </a>
                <a href="{{ url($url.'/cetak-surat/bast-gdn/'. $usulan->id_form_usulan) }}" class="btn btn-default border-dark btn-sm pdf" target="_blank">
                            ...
                            <div class="row">
                                <div class="col-md-7 col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">: {{ $usulan->pegawai->unitKerja->unit_kerja }}</div>
                                        <div class="col-md-3">Jumlah</div>
                                        <div class="col-md-9">: pekerjaan</div>
