    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 form-group">
                ...
                <a href="{{ url('super-user/atk/surat/print-surat-bast/'. $bast->otp_bast_pengusul) }}" rel="noopener" target="_blank" class="btn btn-danger pdf">
                        ...
                        <div class="row text-capitalize">
                            <div class="col-md-12 form-group">
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-md-9">: {{ $bast->keterangan_pegawai }}</div>
                                </div>
                                <div class="form-group row mb-0">
                            ...
                            <div class="col-md-12">
                                <div class="row text-center">
                                    ...
                                    <label class="col-sm-4">Yang Menerima, <br> {{ $bast->jabatan.' '.$bast->keterangan_pegawai }}</label>
