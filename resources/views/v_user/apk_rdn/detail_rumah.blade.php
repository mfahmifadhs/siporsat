        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ url('unit-kerja/rdn/dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active"><a href="{{ url('unit-kerja/rdn/rumah-dinas/daftar/seluruh-rumah') }}">Daftar Rumah</a></li>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="active tab-pane" id="informasi-barang">
                                <form action="{{ url('unit-kerja/rdn/rumah-dinas/proses-ubah/'. $rumah->id_rumah_dinas) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('unit-kerja/oldat/barang/ubah-riwayat/'. $riwayatPenghuni->barang_id) }}">
                                                            @csrf
...
<script>
    ...
    $(function() {
        ...
        $(".select2-pegawai").select2({
            ajax: {
                url: "{{ url('unit-kerja/select2/pegawai') }}",
                type: "post",
                dataType: 'json',
                delay: 250,
    ...
    $(document).on('change', '.penghuni', function() {
        ...
        if (penghuni) {
            $.ajax({
                type: "GET",
                url: "/unit-kerja/jabatan?penghuni=" + penghuni,
                dataType: 'JSON',
