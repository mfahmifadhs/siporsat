    ...
    <div class="container">
        <div class="row text-capitalize">
            ...
            <div class="col-sm-6 text-right my-auto">
                ...
                <a href="{{ url('unit-kerja/cetak-surat/usulan-gdn/'. $usulan->id_form_usulan) }}" rel="noopener" target="_blank" class="btn btn-default border-dark btn-sm pdf">
                    <i class="fas fa-file-alt"></i> Surat Usulan
                </a>
                @endif
                @if($usulan->otp_usulan_kabag)
                <a href="{{ url('unit-kerja/cetak-surat/bast-gdn/'. $usulan->id_form_usulan) }}" class="btn btn-default border-dark btn-sm pdf" target="_blank">
                            ...
                            <div class="row">
                                <div class="col-md-7 col-12 text-sm">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">: {{ $usulan->detailUsulanGdn?->count() }} pekerjaan</div>
