...
<section class="content">
    <div class="container">
        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <form action="{{ url('unit-kerja/gdn/usulan/edit/'. $usulan->id_form_usulan) }}" method="POST">
                    @csrf
                    ...
                    <div id="main-gdn">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="lokasi_spesifik[]" class="form-control" rows="10">{!! nl2br(e($detail->lokasi_spesifik)) !!}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
