...
<div class="content-header">
    <div class="container">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Gedung Bangunan (GDN)</h1>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-md-3 col-12">
                        <a href="{{ route('gdn.show', ['aksi' => 'proses', 'id' => 1]) }}">
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h3>{{ $usulan->where('status_proses_id', 1)->count() }} <small>usulan</small></h3>
                    ...
                    <div class="col-md-3 col-12">
                        <a href="{{ route('gdn.show', ['aksi' => 'proses', 'id' => 2]) }}">
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h3>{{ $usulan->where('status_proses_id', 2)->count() }} <small>usulan</small></h3>
                                    <p>PROSES</p>
                                </div>
                                <div class="icon p-2">
                                    <i>2</i>
                    ...
                    <div class="col-md-3 col-12">
                        <a href="{{ route('gdn.show', ['aksi' => 'proses', 'id' => 5]) }}">
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h3>{{ $usulan->where('status_proses_id', 5)->count() }} <small>usulan</small></h3>
                    ...
                    <div class="col-md-3 col-12">
                        <a href="{{ route('gdn.show', ['aksi' => 'verifikasi', 'id' => 2]) }}">
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h3>{{ $usulan->where('status_pengajuan_id', 2)->count() }} <small>usulan</small></h3>
