                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @if ($dataUsulan->status_proses_id == 1)
                                            <a class="dropdown-item btn" href="{{ url('unit-kerja/gdn/usulan/edit/'. $dataUsulan->id_form_usulan) }}">
                                            ...
                                            <a class="dropdown-item btn" href="{{ url('unit-kerja/verif/usulan-gdn/'. $dataUsulan->id_form_usulan) }}" onclick="return confirm('Apakah pekerjaan telah diterima?')">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body text-capitalize">
                                                ...
                                                <div class="form-group row mb-0">
                                                    ...
                                                    <div class="col-md-8">:
                                                        <a href="{{ url('unit-kerja/surat/detail-bast-gdn/'. $dataUsulan->id_form_usulan) }}">
