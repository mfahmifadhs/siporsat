      ...
      <div class="row mb-2">
         <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
               <li class="breadcrumb-item"><a href="{{ url('unit-kerja/aadb/dashboard') }}">Dashboard</a></li>
                     ...
                     <div class="modal fade" id="modal-foto">
                        <div class="modal-dialog">
                           <div class="modal-content">
                              ...
                              <form action="{{ url('unit-kerja/aadb/kendaraan/proses-ubah/'. $kendaraan->id_kendaraan) }}" method="POST" enctype="multipart/form-data">
                                 ...
                                 <div class="timeline-body">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-12">
                                          ...
                                          <a class="btn btn-danger btn-xs" href="{{ url('unit-kerja/aadb/kendaraan/hapus-riwayat/'. $riwayatPengguna->id_riwayat_kendaraan) }}" onclick="return confirm('Hapus Riwayat Ini ?')">
                                 ...
                                 <div class="modal-dialog">
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-body">
                                          <form action="{{ url('unit-kerja/aadb/kendaraan/ubah-riwayat/'. $riwayatPengguna->kendaraan_id) }}">
                                             @csrf
