                ...
                <form class="form-pengajuan" action="{{ url('unit-kerja/oldat/usulan/proses-usulan/'. $aksi ) }}" method="POST">
                    ...
                    <div id="input-barang-pengadaan">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="merk_barang[]" placeholder="Merk" required>
                            </div>
                        </div>
                        <div class="form-group row">
    ...
    $(function() {
        ...
        $(document).on('change', '.kategori', function() {
            ...
            if (kategori) {
                $.ajax({
                    type: "GET",
                    url: "/unit-kerja/oldat/select2/daftar?kategori=" + kategori,
                    dataType: 'JSON',
        ...
        $(document).on('change', '.spekBarang', function() {
            ...
            if (idBarang) {
                $.ajax({
                    type: "GET",
                    url: "/unit-kerja/oldat/select2/detail?idBarang=" + idBarang,
                    dataType: 'JSON',
                    success: function(res) {
