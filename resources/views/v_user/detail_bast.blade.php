        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="{{ url('unit-kerja/'.$modul.'/dashboard') }}">Dashboard {{ $modul }}</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12 form-group">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{ url('unit-kerja/verif/bast-'.$modul.'/'. $bast->usulan_id) }}" method="GET">
                            @csrf
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group row text-capitalize">
                                        ...
                                        <div class="col-md-8">:
                                            ...
                                            <a href="{{ url('unit-kerja/cetak-surat/bast-'.$modul.'/'. $id_bast) }}" class="btn btn-danger btn-sm" rel="noopener" target="_blank">
